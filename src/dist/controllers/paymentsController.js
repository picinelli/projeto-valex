...
export function paymentTransaction(req, res) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService.paymentTransaction(paymentInfo)];
                case 1:
                    _a.sent();
...
export function paymentOnlineTransaction(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var paymentInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService.paymentOnlineTransaction(paymentInfo)];
                case 1:
                    _a.sent();
                    res.status(200).send("Pagamento efetuado com sucesso");
                    return [2 /*return*/];
