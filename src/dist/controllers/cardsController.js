...
export function createCard(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var API, body, securityCode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    API = req.header("x-api-key");
                    body = req.body;
                    return [4 /*yield*/, cardService.createCard(body, API)];
                case 1:
                    securityCode = _a.sent();
...
export function createVirtualCard(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var body, securityCode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    body = req.body;
                    validateSchema(virtualCardCreationSchema, body);
                    return [4 /*yield*/, cardService.createVirtualCard(body)];
                case 1:
                    securityCode = _a.sent();
                    res.status(201).send(securityCode);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cardService.deleteCard(cardInfo)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cardService.activateCard(cardInfo)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cardService.blockCardById(cardInfo)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cardInfo = req.body;
                    validateSchema(cardBlockSchema, cardInfo);
                    return [4 /*yield*/, cardService.unblockCardById(cardInfo)];
                case 1:
                    _a.sent();
